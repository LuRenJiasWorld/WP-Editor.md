...
class editormd {
            ...
            jQuery(document).ready(function ($) {
                ...
                $(function () {
                    EditorMD = editormd("wp-content-editor-container", {
                        width: "100%", //编辑器宽度
                        height: 640,    //编辑器高度
                        syncScrolling: <?php isset( $options['support_sync_scrolling'] ) && $options['support_sync_scrolling'] == 1 ? print( "true" ) : print( "false" ); ?>,   //即是否开启同步滚动预览
	...
	public function emoji_enqueue_scripts() {
		...
		wp_enqueue_style( 'katex_css', WP_EDITORMD_PLUGIN_URL . '/KaTeX/katex.min.css', array(), WP_EDITORMD_PLUGIN_VERSION, 'all' );
		wp_enqueue_script( 'katex_js', WP_EDITORMD_PLUGIN_URL . '/KaTeX/katex.min.js', array(), WP_EDITORMD_PLUGIN_VERSION, false );
	}
