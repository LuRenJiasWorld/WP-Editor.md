...
/*! Check if previously processed */if(a.getAttribute("data-processed"))continue;a.setAttribute("data-processed",!0);const o=`mermaid-${Date.now()}`;r=a.innerHTML,r=i.a.decode(r).trim().replace(/<br>/gi,"<br/>"),_n.render(o,r,(t,e)=>{a.innerHTML=t,void 0!==n&&n(o),e&&e(a)},a)}},initialize:function(t){b.debug("Initializing mermaid "),void 0!==t.mermaid&&(void 0!==t.mermaid.startOnLoad&&(wn.startOnLoad=t.mermaid.startOnLoad),void 0!==t.mermaid.htmlLabels&&(wn.htmlLabels=t.mermaid.htmlLabels)),_n.initialize(t)},contentLoaded:xn};e.default=wn}]).default});
